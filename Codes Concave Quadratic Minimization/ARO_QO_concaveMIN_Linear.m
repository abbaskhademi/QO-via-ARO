function [LB,UB,Total_Time,sol_x]=ARO_QO_concaveMIN_Linear(Q,c,A,b) 

% ARO-QO Algorithm: with affine decision rule for Concave Quadratic Mimimization
...
% Extract LB value 
    ...
    LB = value(tau);     
    Algorithm = {'(ARO QO): LB with Affine Decision Rule'};
